...
export class ApplicationServiceProxy {
    ...
    /**
     * @param includeUnpublished (optional) 
     ...
     * @return Success
     */
    getList(includeUnpublished: boolean | undefined, includeDeleted: boolean | undefined, filter: string | undefined, sorting: string | undefined, maxResultCount: number | undefined): Observable<ApplicationDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Application/GetList?";
        if (includeUnpublished === null)
            throw new Error("The parameter 'includeUnpublished' cannot be null.");
        else if (includeUnpublished !== undefined)
            url_ += "IncludeUnpublished=" + encodeURIComponent("" + includeUnpublished) + "&";
    ...
    protected processGetList(response: HttpResponseBase): Observable<ApplicationDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getDetails(id: number | undefined): Observable<ApplicationDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/Application/GetDetails?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ApplicationDetailsDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApplicationDetailsDto>;
        }));
    }

    protected processGetDetails(response: HttpResponseBase): Observable<ApplicationDetailsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApplicationDetailsDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    create(body: CreateApplicationInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    runApplication(id: number | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Application/RunApplication?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRunApplication(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRunApplication(response_ as any);
                } catch (e) {
    ...
    protected processRunApplication(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    uploadToAzure(id: number | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Application/UploadToAzure?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUploadToAzure(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUploadToAzure(response_ as any);
                } catch (e) {
    ...
    protected processUploadToAzure(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class ConfigurationServiceProxy {
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Configuration/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
...
@Injectable()
export class DependencyServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateDependencyDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Dependency/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Dependency/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<Dependency> {
        let url_ = this.baseUrl + "/api/services/app/Dependency/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<Dependency>;
                }
            } else
                return _observableThrow(response_) as any as Observable<Dependency>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<Dependency> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = Dependency.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getList(filter: string | undefined, sorting: string | undefined, maxResultCount: number | undefined): Observable<Dependency[]> {
        let url_ = this.baseUrl + "/api/services/app/Dependency/GetList?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
    ...
    protected processGetList(response: HttpResponseBase): Observable<Dependency[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(Dependency.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
@Injectable()
export class GithubProfileServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateGithubProfileDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/GithubProfile/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/GithubProfile/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<GithubProfile> {
        let url_ = this.baseUrl + "/api/services/app/GithubProfile/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GithubProfile>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GithubProfile>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<GithubProfile> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GithubProfile.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getList(filter: string | undefined, sorting: string | undefined, maxResultCount: number | undefined): Observable<GithubProfile[]> {
        let url_ = this.baseUrl + "/api/services/app/GithubProfile/GetList?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
    ...
    protected processGetList(response: HttpResponseBase): Observable<GithubProfile[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(GithubProfile.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
@Injectable()
export class GithubRepositoryServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<GithubRepository> {
        let url_ = this.baseUrl + "/api/services/app/GithubRepository/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GithubRepository>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GithubRepository>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<GithubRepository> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GithubRepository.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getList(filter: string | undefined, sorting: string | undefined, maxResultCount: number | undefined): Observable<GithubRepository[]> {
        let url_ = this.baseUrl + "/api/services/app/GithubRepository/GetList?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
    ...
    protected processGetList(response: HttpResponseBase): Observable<GithubRepository[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(GithubRepository.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    create(body: CreateGithubRepositoryDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/GithubRepository/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/GithubRepository/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    findGithubRepositoryForApplicationId(applicationId: number | undefined): Observable<GithubRepository> {
        let url_ = this.baseUrl + "/api/services/app/GithubRepository/findGithubRepositoryForApplicationId?";
        if (applicationId === null)
            throw new Error("The parameter 'applicationId' cannot be null.");
        else if (applicationId !== undefined)
            url_ += "applicationId=" + encodeURIComponent("" + applicationId) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFindGithubRepositoryForApplicationId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFindGithubRepositoryForApplicationId(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GithubRepository>;
                }
            } else
    ...
    protected processFindGithubRepositoryForApplicationId(response: HttpResponseBase): Observable<GithubRepository> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class ApplicationDetailsDto implements IApplicationDetailsDto {
    ...
    constructor(data?: IApplicationDetailsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ApplicationDetailsDto {
        data = typeof data === 'object' ? data : {};
        let result = new ApplicationDetailsDto();
        result.init(data);
        return result;
    }
...
export interface IApplicationDetailsDto {
    name: string | undefined;
    description: string | undefined;
    version: string | undefined;
    type: string | undefined;
...
export class CreateDependencyDto implements ICreateDependencyDto {
    name: string | undefined;
    version: string | undefined;
    type: string | undefined;
    ...
    constructor(data?: ICreateDependencyDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.version = _data["version"];
            this.type = _data["type"];
            this.officialUrl = _data["officialUrl"];
            this.targetFramework = _data["targetFramework"];
        }
    }

    static fromJS(data: any): CreateDependencyDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateDependencyDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["version"] = this.version;
        data["type"] = this.type;
        data["officialUrl"] = this.officialUrl;
        data["targetFramework"] = this.targetFramework;
        return data;
    }

    clone(): CreateDependencyDto {
        const json = this.toJSON();
        let result = new CreateDependencyDto();
        result.init(json);
        return result;
...
export interface ICreateDependencyDto {
    name: string | undefined;
    version: string | undefined;
    type: string | undefined;
    officialUrl: string | undefined;
...
export class CreateGithubProfileDto implements ICreateGithubProfileDto {
    username: string | undefined;
    token: string | undefined;
    description: string | undefined;
    userId: number;

    constructor(data?: ICreateGithubProfileDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateGithubProfileDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateGithubProfileDto();
        result.init(data);
        return result;
    }
...
export interface ICreateGithubProfileDto {
    username: string | undefined;
    token: string | undefined;
    description: string | undefined;
    userId: number;
...
export class CreateGithubRepositoryDto implements ICreateGithubRepositoryDto {
    ...
    static fromJS(data: any): CreateGithubRepositoryDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateGithubRepositoryDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateGithubRepositoryDto {
        const json = this.toJSON();
        let result = new CreateGithubRepositoryDto();
        result.init(json);
        return result;
...
export interface ICreateGithubRepositoryDto {
    repositoryName: string | undefined;
    description: string | undefined;
    githubProfileId: number;
    applicationId: number;
...
export class GithubProfile implements IGithubProfile {
    id: number;
    username: string | undefined;
    token: string | undefined;
    description: string | undefined;
    ...
    constructor(data?: IGithubProfile) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GithubProfile {
        data = typeof data === 'object' ? data : {};
        let result = new GithubProfile();
        result.init(data);
        return result;
    }
...
export class GithubRepository implements IGithubRepository {
    ...
    static fromJS(data: any): GithubRepository {
        data = typeof data === 'object' ? data : {};
        let result = new GithubRepository();
        result.init(data);
        return result;
    }
