...
{
    public abstract class HotSpotWebWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HotSpotWebWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HotSpotWebWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HotSpotWebDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HotSpotWebDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HotSpotWebDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HotSpotWebDbContext, Task<T>> func)
        {
            T result;
