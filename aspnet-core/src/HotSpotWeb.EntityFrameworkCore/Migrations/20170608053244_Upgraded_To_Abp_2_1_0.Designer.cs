...
namespace HotSpotWeb.Migrations
{
    ...
    partial class Upgraded_To_Abp_2_1_0
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HotSpotWeb.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("HotSpotWeb.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("HotSpotWeb.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("HotSpotWeb.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("HotSpotWeb.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("HotSpotWeb.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
