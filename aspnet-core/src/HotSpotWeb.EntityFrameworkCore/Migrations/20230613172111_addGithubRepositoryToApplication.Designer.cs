...
namespace HotSpotWeb.Migrations
{
    ...
    [Migration("20230613172111_addGithubRepositoryToApplication")]
    partial class addGithubRepositoryToApplication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotSpotWeb.Applications.Application", b =>
                {
                    ...
                    b.HasOne("HotSpotWeb.GithubRepositories.GithubRepository", "GithubRepository")
                        .WithMany()
