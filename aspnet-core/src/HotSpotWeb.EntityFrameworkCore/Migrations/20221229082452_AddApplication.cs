        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VersionControl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RepositoryUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RepositoryUsername = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RepositoryBranch = table.Column<string>(type: "nvarchar(max)", nullable: true),
