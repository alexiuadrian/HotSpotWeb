...
namespace HotSpotWeb.Migrations
{
    ...
    [Migration("20230614134830_addIsApplicationOnRepositoryOnGitRepo")]
    partial class addIsApplicationOnRepositoryOnGitRepo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotSpotWeb.GithubProfiles.GithubProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotSpotWeb.GithubRepositories.GithubRepository", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsApplicationOnRepository")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("HotSpotWeb.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("HotSpotWeb.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("HotSpotWeb.GithubRepositories.GithubRepository", b =>
                {
                    b.HasOne("HotSpotWeb.Applications.Application", "Application")
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotSpotWeb.GithubProfiles.GithubProfile", "GithubProfile")
                        .WithMany()
